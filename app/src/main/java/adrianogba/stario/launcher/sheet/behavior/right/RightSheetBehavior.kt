...
class RightSheetBehavior<V : View>(
    context: Context,
    attrs: AttributeSet?
    ...
    override fun calculateExpandedOffset() {
        ...
        if (sheet != null) {
            expandedOffset = parentWidth - sheet.measuredWidth
        }
    }
    ...
    override fun touchEventLogic(child: V, event: MotionEvent) {
        val delta = initial - event.x

        val helper = dragHelper
        if (helper != null && abs(delta) > helper.touchSlop) {
    ...
    override fun instantiateDragCallback(): SheetDragHelper.Callback {
        return object : SheetDragHelper.Callback() {
            ...
            override fun tryCaptureView(child: View, pointerId: Int): Boolean {
                ...
                if (state == STATE_EXPANDED && activePointerId == pointerId) {
                    ...
                    if (pager != null) {
                        ...
                        if (adapter != null && pager.currentItem > 0) {
                            return false
                        }
                    }
            ...
            override fun onViewReleased(releasedChild: View, xvel: Float, yvel: Float) {
                ...
                settleChildTo(releasedChild, targetState, left, releasedChild.top)
            }
