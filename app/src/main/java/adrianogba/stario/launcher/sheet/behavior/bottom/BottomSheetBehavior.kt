...
package adrianogba.stario.launcher.sheet.behavior.bottom
...
class BottomSheetBehavior<V : View>(
    context: Context,
    attrs: AttributeSet?
        ...
        return object : SheetDragHelper.Callback() {
            ...
            override fun tryCaptureView(child: View, pointerId: Int): Boolean {
                ...
                if (state == STATE_EXPANDED && activePointerId == pointerId) {
                    ...
                    if (scroll is OverScrollRecyclerView) {
                        val pullEdges = scroll.overscrollPullEdges

                        if ((pullEdges and OverScrollEffect.PULL_EDGE_TOP) == OverScrollEffect.PULL_EDGE_TOP) {
                            return false
                        }
                    }
