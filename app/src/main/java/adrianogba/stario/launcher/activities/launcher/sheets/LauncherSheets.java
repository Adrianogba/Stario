...
public class LauncherSheets {
    public static final String INTENT_SHEET_CLASS_EXTRA = "adrianogba.stario.launcher.INTENT_SHEET_CLASS_EXTRA";
    public static final String ACTION_REMOVE_SHEET = "adrianogba.stario.launcher.ACTION_REMOVE_SHEET";
    public static final String ACTION_MOVE_SHEET = "adrianogba.stario.launcher.ACTION_MOVE_SHEET";
    public static final String ACTION_ADD_SHEET = "adrianogba.stario.launcher.ACTION_ADD_SHEET";
