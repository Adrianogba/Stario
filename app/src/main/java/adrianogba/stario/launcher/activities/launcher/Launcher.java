...
public class Launcher extends ThemedActivity {
    public static final String INTENT_KILL_TASK_ID_EXTRA = "adrianogba.stario.launcher.INTENT_KILL_TASK_ID_EXTRA";
    public static final String ACTION_KILL_TASK = "adrianogba.stario.launcher.ACTION_KILL_TASK";
