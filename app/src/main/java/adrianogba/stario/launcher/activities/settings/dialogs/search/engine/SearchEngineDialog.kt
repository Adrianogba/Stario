...
class SearchEngineDialog(activity: ThemedActivity) : ActionDialog(activity) {

    override fun inflateContent(inflater: LayoutInflater): View {
        val root = inflater.inflate(R.layout.pop_up_engine, null)
        ...
        recycler.adapter = SearchEngineRecyclerAdapter(activity) { dismiss() }
