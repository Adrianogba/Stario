...
class AccessibilityConfigurator(activity: ThemedActivity) : ActionDialog(activity) {

    override fun inflateContent(inflater: LayoutInflater): View {
        val root = inflater.inflate(R.layout.pop_up_accesibility, null)
    ...
    private fun showSettingsActivity() {
        val showArgs = BuildConfig.APPLICATION_ID + "/" + AccessibilityService::class.java.name
