...
public final class ProfileManager {
    public static final String PROFILE_AVAILABLE_EXTRA = "adrianogba.stario.launcher.PROFILE_AVAILABLE_EXTRA";

    private static final String PROFILE_AVAILABLE_INTENT = "adrianogba.stario.launcher.PROFILE_AVAILABLE_INTENT";
