...
public class NotificationService extends NotificationListenerService {
    ...
    public static final String NOTIFICATIONS_EVENT = "adrianogba.stario.launcher.NOTIFICATIONS_LISTENER_EVENT";
    public static final String UPDATE_NOTIFICATIONS = "adrianogba.stario.launcher.UPDATE_NOTIFICATIONS";
    public static final String TARGET_NOTIFICATION = "adrianogba.stario.launcher.TARGET_NOTIFICATION";
    public static final String NOTIFICATION_COUNT = "adrianogba.stario.launcher.NOTIFICATION_COUNT";
