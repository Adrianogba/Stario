...
- **Java to Kotlin.** 204 of 209 files. Across: the whole app model, the whole
...
- What is left is two files: `DynamicGridLayout` at 1412 lines, the biggest in
  the project, and `Settings`.
