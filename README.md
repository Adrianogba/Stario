...
- **Java to Kotlin.** 203 of 209 files. Across: the whole app model, the whole
...
- What is left is three files, all of them large: `DynamicGridLayout` at 1412
  lines is the biggest in the project, then `Settings` and `SearchFragment`.
